...
-- function PB_states.set_up_area(state)
...
-- function PB_states.filter_entities(state)
...
-- function PB_states.initial_poles(state)
...
-- function PB_states.initialise_counts(state)
...
-- function PB_states.collision_check(state)
--     if state.count < state.width then
--         for j = 1, state.height do
...
-- function PB_states.place_initial_pole(state)
...
-- function PB_states.join_networks(state)
...
-- function PB_states.place_best_pole(state)
...
-- function PB_states.register(state)
